...
export default function ServiceManagement() {
  ...
  // Memoize fetchServices to avoid stale closures
        ...
        setServices([
          {
            ...
            description: "Initial consultation to discuss business needs and strategies",
            price: 150,
            duration: 60,
            is_active: true,
            provider_id: "demo",
          ...
          },
          {
            id: "2",
            name: "Tax Planning",
            description: "Comprehensive tax planning and strategy session",
            price: 200,
            duration: 90,
            is_active: true,
            provider_id: "demo",
          ...
          },
          {
            ...
            description: "Review of financial statements and recommendations",
            price: 175,
            duration: 75,
            is_active: false,
            provider_id: "demo",
  ...
  // Fetch services on component mount and set up realtime subscription
  useEffect(() => {
    fetchServices()
  ...
  }, [realtimeSubscribed, fetchServices]) // Include fetchServices in dependencies
      ...
      if (!user) {
        if (isDemoMode) {
          ...
          if (editingId) {
            ...
            toast({
              title: "Service updated (Demo)",
              description: "Your service has been updated successfully in demo mode",
              variant: "default",
            })
          } else {
            // Create new demo service
            const newService = {
              id: newId,
              name: formData.name,
              description: formData.description,
            ...
            toast({
              title: "Service created (Demo)",
              description: "Your new service has been created successfully in demo mode",
              variant: "default",
            })
          }
    ...
    try {
      ...
      if (!user) {
        if (isDemoMode) {
          ...
          toast({
            title: "Service deleted (Demo)",
            description: "The service has been deleted successfully in demo mode",
            variant: "default",
          })
          return
        } else {
      ...
      if (!user) {
        if (isDemoMode) {
          ...
          setServices((prevServices) =>
            prevServices.map((service) =>
              service.id === id
                ? { ...service, is_active: !currentStatus, updated_at: new Date().toISOString() }
                : service,
            ),
          )

          toast({
            title: `Service ${!currentStatus ? "activated" : "deactivated"} (Demo)`,
            description: `The service has been ${!currentStatus ? "activated" : "deactivated"} successfully in demo mode`,
            variant: "default",
          })
          return
        } else {
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[550px]">
            <DialogHeader>
              ...
              {/* Demo mode warning - moved outside of DialogDescription to avoid nesting div in p */}
              {isDemoMode && (
                <div className="mt-2 text-amber-500 text-sm flex items-center">
                  <AlertTriangle className="h-4 w-4 mr-1" />
                  <span>Demo Mode: Changes will not be saved permanently</span>
                </div>
              )}
            </DialogHeader>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">
                You are currently in demo mode. Changes to services will not be saved permanently. Sign in to manage
